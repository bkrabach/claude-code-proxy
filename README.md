...
3. **Configure Environment Variables**:
  ...
  *   `AZURE_OPENAI_API_KEY`: (Optional) Azure OpenAI key. Leave blank to use Managed Identity.
  *   `AZURE_OPENAI_API_VERSION` (Optional): API version to use.
  *   `AZURE_MANAGED_IDENTITY_CLIENT_ID` (Optional): Client ID if using a user-assigned identity.
